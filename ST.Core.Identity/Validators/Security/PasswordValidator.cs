...
using System.Linq;
using ST.Core.Identity.Data; // Reference to your seed data project
...
namespace ST.Core.Identity
{
    ...
    public class PasswordValidator
    {
        ...
        private void CheckNotEmpty(string password, List<string> errors)
        {
        ...
        /// <param name="password">The password to check.</param>
        /// <param name="errors">The list to which error messages are added.</param>
        private void CheckMinimumLength(string password, List<string> errors)
        {
