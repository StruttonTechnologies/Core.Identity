...
public static class ServiceCollectionExtensions
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        services.AddTransient<IRequestHandler<SignOutAllDevicesCommand, SignOutResultDto>, SignOutAllDevicesCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<RefreshAuthenticationTokenCommand, RefreshTokenResultDto>, RefreshAuthenticationTokenCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<ChangePasswordCommand, ChangePasswordResultDto>, ChangePasswordCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<ConfirmEmailCommand, ConfirmEmailResultDto>, ConfirmEmailCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<ForgotPasswordCommand, ForgotPasswordResultDto>, ForgotPasswordCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<ResetPasswordCommand, ResetPasswordResultDto>, ResetPasswordCommandHandler<TUser, TKey>>();
        ...
        services.AddTransient<IRequestHandler<ResendEmailConfirmationCommand, ResendEmailConfirmationResultDto>, ResendEmailConfirmationCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<SetupMfaCommand, MfaSetupResultDto>, SetupMfaCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<VerifyMfaCommand, MfaVerifyResultDto>, VerifyMfaCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<DisableMfaCommand, MfaVerifyResultDto>, DisableMfaCommandHandler<TUser, TKey>>();
        services.AddTransient<IRequestHandler<RegenerateMfaRecoveryCodesCommand, MfaRecoveryCodesResultDto>, RegenerateMfaRecoveryCodesCommandHandler<TUser, TKey>>();
        ...
        services.AddTransient<IRequestHandler<RemoveClaimCommand, IdentityResult>, RemoveClaimCommandHandler<TUser, TKey>>();
        ...
        services.AddTransient<IRequestHandler<RefreshTokenCommand, RefreshTokenResultDto>, RefreshTokenCommandHandler<TUser, TKey>>();
