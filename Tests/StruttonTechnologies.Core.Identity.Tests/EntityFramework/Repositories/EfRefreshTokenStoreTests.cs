...
namespace StruttonTechnologies.Core.Identity.Tests.EntityFramework.Repositories;
...
public sealed class EfRefreshTokenStoreTests : IDisposable
{
    ...
    [Fact]
    public async Task SaveAsync_ThrowsArgumentNullException_WhenTokenIsNull()
    {
        await Assert.ThrowsAsync<ArgumentNullException>(async () =>
            await _store.SaveAsync(null!, CancellationToken.None));
    }
    ...
    [Fact]
    public async Task GetAsync_ThrowsArgumentNullException_WhenTokenIsNull()
    {
        await Assert.ThrowsAsync<ArgumentNullException>(async () =>
            await _store.GetAsync(null!, CancellationToken.None));
    }
    ...
    [Fact]
    public async Task RevokeAsync_ThrowsArgumentNullException_WhenTokenIsNull()
    {
        await Assert.ThrowsAsync<ArgumentNullException>(async () =>
            await _store.RevokeAsync(null!, CancellationToken.None));
    }
