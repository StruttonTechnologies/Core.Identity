...
namespace StruttonTechnologies.Core.Identity.Tests.Handlers.Authentication;
...
public class AuthenticateUserHandlerTests : CoordinatorHandlerTestBase
{
    ...
    public async Task Handle_WhenRequestIsValid_DelegatesToAuthenticationOrchestration()
    {
        ...
        AuthenticationResultDto expected = AuthenticationResultDto.SuccessResult("access-token", "refresh-token");
